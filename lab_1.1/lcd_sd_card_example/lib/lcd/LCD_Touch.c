...
void TP_Save(void)
{
    ...
    printf("TP_Save: copying data.\n");
    if (!tp_data || !p_mutex) {
        printf("TP_Save: tp_data or mutex not initialized\r\n");
        return;
    }
    printf("TP_Save: blocking.\n");
